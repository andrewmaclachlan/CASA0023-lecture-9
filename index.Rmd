...
.pull-right[
```{r echo=FALSE, out.width='100%', fig.align='center'}
  knitr::include_graphics('img/product-tree-all.png')
```
...
Here we can apply similar logic to test for changes between images....
...
Section 1 and 2: https://besjournals.onlinelibrary.wiley.com/doi/10.1111/2041-210X.12942

Mainly up to page 354. https://www.tandfonline.com/doi/pdf/10.2747/1548-1603.48.3.345?needAccess=true
